...
void DMA_voidInit(eDMA_Number_t DMA_Number)
{
	...
	RCC_PerClock_State(AHB , DMA1_PERIPHERAL  +  DMA_Number , PClock_enable);
...
{
	DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR  = 0x00000000;
	/* Disable  Channel */
	CLR_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR  ,  0 );

	/* memory to memory mode  */

	DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR  |= ( DMA_Config->M2M_Mode << 14 );

/*
	if (DMA_Config->M2M_Mode == DMA_ENABLE )
		SET_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,14);
	else
		CLR_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,14);
*/
	...
	/* Memory Increment  */
	DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR |= (DMA_Config->MemoryIncrement << 7);

/*
	if (DMA_Config->MemoryIncrement == DMA_ENABLE )
		SET_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,7);
	else
		CLR_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,7);
*/
	/* Peripheral Increment  */
	DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR |=(DMA_Config->PeripheralIncrement << 6);
/*
	if (DMA_Config->PeripheralIncrement == DMA_ENABLE )
		SET_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,6);
	else
		CLR_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,6);*/

	/* Read From Memory  */
	DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR |= (DMA_Config->DataDirection << 4);
	/*
	if (DMA_Config->DataDirection == ReadFromMemory )
		SET_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,4);
	else
		CLR_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,4);*/
	...
	if (DMA_Config->TransferErrorInterrupt == DMA_ENABLE )
		...
		CLR_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,3);
	...
	if (DMA_Config->HalfTransferInterrupt == DMA_ENABLE )
		...
		CLR_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,2);
	...
	if (DMA_Config->TransferCompleteInterrupt == DMA_ENABLE )
		...
		CLR_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,1);

	/* Circle */
	if (DMA_Config->CircularMode== DMA_ENABLE )
		SET_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,5);
	else
		CLR_BIT(DMAx[DMA_Config->DMA_Number]->Channel[DMA_Config->DMA_Channel].CRR ,5);
 ...
 * @return  void
 */
void DMA_voidSetCallBack(eDMA_Number_t DMA_Number ,eDMA_Channel_t DMA_Channel,eDMA_InterruptSource_t DMA_InterruptSource ,
		                  void (*LocalFptr)(void) ){
